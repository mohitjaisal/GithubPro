...
const defaultTitle = 'GithubPro';
const defaultDescription = 'A nicer look at your GitHub profile. With charts!';
const defaultOGURL = 'https://githubpro.netlify.app';
const defaultOGImage = 'https://githubpro.netlify.app/static/gp.png';
...
const Head = props => (
  <NextHead>
    ...
    <meta name="twitter:creator" content={'@mohitjaisal'} />
